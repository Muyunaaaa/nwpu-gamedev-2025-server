...
namespace myu {
    namespace Physics::Details {
        static void TraceImpl(const char *inFMT, ...) {
            ...
            spdlog::info("JoltPhysics trace: {}", buffer);
        }
        ...
        static bool AssertFailedImpl(const char *inExpression, const char *inMessage, const char *inFile,
                                     JPH::uint inLine) {
            spdlog::critical("JoltPhysics assertion failed. {}:{}: ({}) {}",
    ...
    private:
        ...
        std::unique_ptr<Physics::Details::BPLayerInterfaceImpl> m_broadPhaseLayerInterface;
        std::unique_ptr<Physics::Details::ObjectVsBroadPhaseLayerFilterImpl> m_objectVsBroadPhaseLayerFilter;
        std::unique_ptr<Physics::Details::ObjectLayerFilterImpl> m_objectLayerFilter;
