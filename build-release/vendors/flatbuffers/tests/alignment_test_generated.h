...
struct SmallStructs FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  void UnPackTo(SmallStructsT *_o, const ::flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static ::flatbuffers::Offset<SmallStructs> Pack(::flatbuffers::FlatBufferBuilder &_fbb, const SmallStructsT* _o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
};
...
struct SmallStructsBuilder {
  ...
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_even_structs(::flatbuffers::Offset<::flatbuffers::Vector<const EvenSmallStruct *>> even_structs) {
    fbb_.AddOffset(SmallStructs::VT_EVEN_STRUCTS, even_structs);
  }
  void add_odd_structs(::flatbuffers::Offset<::flatbuffers::Vector<const OddSmallStruct *>> odd_structs) {
...
inline ::flatbuffers::Offset<SmallStructs> CreateSmallStructsDirect(
  ...
  auto even_structs__ = even_structs ? _fbb.CreateVectorOfStructs<EvenSmallStruct>(*even_structs) : 0;
...
::flatbuffers::Offset<SmallStructs> CreateSmallStructs(::flatbuffers::FlatBufferBuilder &_fbb, const SmallStructsT *_o, const ::flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
inline bool operator==(const SmallStructsT &lhs, const SmallStructsT &rhs) {
  return
      (lhs.even_structs == rhs.even_structs) &&
...
inline SmallStructsT *SmallStructs::UnPack(const ::flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<SmallStructsT>(new SmallStructsT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}

inline void SmallStructs::UnPackTo(SmallStructsT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = even_structs(); if (_e) { _o->even_structs.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->even_structs[_i] = *_e->Get(_i); } } else { _o->even_structs.resize(0); } }
  { auto _e = odd_structs(); if (_e) { _o->odd_structs.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->odd_structs[_i] = *_e->Get(_i); } } else { _o->odd_structs.resize(0); } }
}

inline ::flatbuffers::Offset<SmallStructs> SmallStructs::Pack(::flatbuffers::FlatBufferBuilder &_fbb, const SmallStructsT* _o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  return CreateSmallStructs(_fbb, _o, _rehasher);
}

inline ::flatbuffers::Offset<SmallStructs> CreateSmallStructs(::flatbuffers::FlatBufferBuilder &_fbb, const SmallStructsT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { ::flatbuffers::FlatBufferBuilder *__fbb; const SmallStructsT* __o; const ::flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline void FinishSmallStructsBuffer(
